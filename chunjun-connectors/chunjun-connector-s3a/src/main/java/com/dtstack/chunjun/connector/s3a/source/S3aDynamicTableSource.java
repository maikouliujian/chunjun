 ...
 */
package com.dtstack.chunjun.connector.s3a.source;

import com.dtstack.chunjun.conf.FieldConf;
import com.dtstack.chunjun.connector.s3a.conf.HdfsConf;
import com.dtstack.chunjun.connector.s3a.converter.HdfsOrcRowConverter;
import com.dtstack.chunjun.connector.s3a.converter.HdfsParquetRowConverter;
import com.dtstack.chunjun.connector.s3a.converter.HdfsTextRowConverter;
 ...
 * @author tudou
 */
public class S3aDynamicTableSource implements ScanTableSource {

    private final HdfsConf hdfsConf;
    private final TableSchema tableSchema;
    private final List<String> partitionKeyList;

    public S3aDynamicTableSource(HdfsConf hdfsConf, TableSchema tableSchema) {
        this(hdfsConf, tableSchema, new ArrayList<>());
    }

    public S3aDynamicTableSource(
    ...
    public DynamicTableSource copy() {
        return new S3aDynamicTableSource(this.hdfsConf, this.tableSchema);
    }
