 ...
 * @author tudou
 */
public class S3aDynamicTableSink implements DynamicTableSink {

    private final HdfsConf hdfsConf;
    private final TableSchema tableSchema;

    public S3aDynamicTableSink(HdfsConf hdfsConf, TableSchema tableSchema) {
    ...
    public SinkFunctionProvider getSinkRuntimeProvider(Context context) {
        ...
        S3aOutputFormatBuilder builder = S3aOutputFormatBuilder.newBuild(hdfsConf.getFileType());
    ...
    public DynamicTableSink copy() {
        return new S3aDynamicTableSink(hdfsConf, tableSchema);
    }
