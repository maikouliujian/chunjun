...
import com.dtstack.chunjun.connector.s3a.converter.HdfsRawTypeConverter;
 ...
 * @author tudou
 */
public class S3aSourceFactory extends SourceFactory {
    private final HdfsConf hdfsConf;

    public S3aSourceFactory(SyncConf config, StreamExecutionEnvironment env) {
        super(config, env);
        hdfsConf =
