 ...
 */
package com.dtstack.chunjun.connector.s3a.table;

import com.dtstack.chunjun.connector.s3a.conf.HdfsConf;
import com.dtstack.chunjun.connector.s3a.options.HdfsOptions;
import com.dtstack.chunjun.connector.s3a.sink.S3aDynamicTableSink;
import com.dtstack.chunjun.connector.s3a.source.S3aDynamicTableSource;
 ...
 * @author tudou
 */
public class S3aDynamicTableFactory implements DynamicTableSourceFactory, DynamicTableSinkFactory {

    public static final String IDENTIFIER = "s3a-x";
    ...
    public DynamicTableSource createDynamicTableSource(Context context) {
        ...
        return new S3aDynamicTableSource(hdfsConf, physicalSchema, partitionKeys);
    }
    ...
    public DynamicTableSink createDynamicTableSink(Context context) {
        ...
        return new S3aDynamicTableSink(hdfsConf, physicalSchema);
    }
